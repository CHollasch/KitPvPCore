...
public enum ParticleEffect {
	...
	* @displayed by TNT and creeperst
	*/
	...
	*/
	...
	static {
		...
		try {
			packetPlayOutWorldParticles = ReflectionHandler.getConstructor(ReflectionHandler.PacketType.PLAY_OUT_WORLD_PARTICLES.getPacket(), String.class, float.class, float.class, float.class, float.class, float.class, float.class, float.class, int.class);
	...
	* @throws #PacketInstantiationException if the amount is lower than 1 or if the
	* @PacketPlayOutWorldParticles has changed its name or constructor parameters
	*/
	...
	/**
	* Instantiates a new @PacketPlayOutWorldParticles object through reflection especially for
	* the "iconcrack" effect
	*
	...
	* @param amount Amount of particles
	* @return The packet object
	* @throws #PacketInstantiationException if the amount is lower than 1 or if the name or the
	* constructor of @PacketPlayOutWorldParticles have changed
	* @see #instantiatePacket
	*/
	...
	* @throws #PacketSendingException if the packet is null or some methods which are accessed
	* through reflection have changed
	*/
	...
	*/
	...
	/**
	* Displays a particle effect which is only visible for all players within a range of 20 in
	* the world of @param center
	*
	* @param center Center location of the effect
	* @param offsetX Maximum distance particles can fly away from the center on the x-axis
	...
	*/
	...
	/**
	* Displays an icon crack (item break) particle effect which is only visible for the specified
	* players
	*
	* @param center Center location of the effect
	* @param id Id of the icon
	...
	*/
	...
	/**
	* Displays an icon crack (item break) particle effect which is only visible for all players
	...
	*/
	...
	/**
	* Displays an icon crack (item break) effect which is visible for all players whitin the
	...
	*/
	...
	/**
	* Displays a block crack (block break) particle effect which is only visible for the
	* specified players
	*
	* @param center Center location of the effect
	* @param id Id of the block
	...
	*/
	...
	/**
	* Displays a block crack (block break) particle effect which is only visible for all players
	* within a certain range in the world of @param center
	*
	* @param center Center location of the effect
	* @param range Range of the visibility
	...
	*/
	...
	/**
	* Displays a block crack (block break) effect which is visible for all players whitin the
	* maximum range of 20 blocks in the world of @param center
	*
	* @param center Center location of the effect
	* @param id Id of the block
	...
	*/
	...
	/**
	* Displays a block dust particle effect which is only visible for all players within a
	...
	*/
	...
	/**
	* Displays a block dust effect which is visible for all players whitin the maximum range of
	* 20 blocks in the world of @param center
	*
	* @param center Center location of the effect
	* @param id Id of the block
	* @param data Data value
